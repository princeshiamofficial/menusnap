...
async function fixDocs10Hours() {
  ...
  try {
    console.log('Fetching magic_docs. Fixing dates before April 11 (+10 hours correction)...');
    ...
    for (const row of rows) {
      ...
      const processDate = (dateStr) => {
        ...
        // TARGET CONDITION: Before 11th (e.g. Apr 7th)
        // If showing Apr 6th 11:35 PM, but should be Apr 7th 09:35 AM, it is exactly +10 hours gap.
    ...
    console.log(`Fix successful. Applied +10H correction to ${updatedCount} rows before April 11.`);
