...
export function FreeDesignHappyClient() {
  return (
    <section id="happy-clients" className="scroll-mt-[120px] bg-slate-50 pt-4 pb-2 md:pt-6 md:pb-4 px-[2%] md:px-12 lg:px-24 font-bengali">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="relative w-full rounded-2xl md:rounded-3xl overflow-hidden border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.06)] bg-white"
        >
          <Image
            src="/happclient.png"
