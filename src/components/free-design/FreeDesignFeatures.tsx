    ...
    <section id="features" className="scroll-mt-[120px] bg-white pt-3 pb-6 md:pt-5 md:pb-10 px-6 md:px-12 lg:px-24 border-t border-slate-100 font-bengali">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h2 className="text-[#1A1A1A] text-[20px] sm:text-3xl md:text-5xl font-serif mb-6 leading-tight">
        ...
        <motion.div
          ...
          className="w-full overflow-hidden rounded-2xl border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.04)] bg-[#FAF9F6] p-6 md:p-10"
        >
