...
import { LayoutDashboard, CalendarDays, ListChecks, Briefcase } from 'lucide-react';
import {
  SidebarMenu,
  SidebarMenuItem,
  SidebarMenuButton,
} from '@/components/ui/sidebar'; // Assuming sidebar components exist
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* <div className="mt-auto p-4 border-t border-sidebar-border">
        <p className="text-xs text-sidebar-foreground/70 group-data-[collapsible=icon]:hidden">© 2024 BizView</p>
      </div> */}
    </div>
  );
}
