        ...
        <CardContent className="p-8 pt-2">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-1">
              <Label htmlFor="business-type" className="flex items-center text-slate-700 dark:text-slate-300 font-bold text-sm">
              ...
              <Select onValueChange={handleTypeChange} required value={type}>
                <SelectTrigger id="business-type" className="h-12 border-gray-200 dark:border-slate-800 rounded-xl focus:ring-orange-500 bg-transparent">
            ...
            <div className="space-y-1">
              <Label htmlFor="business-name" className="flex items-center text-slate-700 dark:text-slate-300 font-bold text-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                <Label htmlFor="division" className="flex items-center text-slate-700 dark:text-slate-300 font-bold text-sm">
                  <MapPin className="h-4 w-4 mr-2" />
                  Division
                </Label>
                <Select onValueChange={(val) => { setDivision(val); setDistrict(''); }} required value={division}>
                  <SelectTrigger id="division" className="h-12 border-gray-200 dark:border-slate-800 rounded-xl focus:ring-orange-500 bg-transparent">
              ...
              <div className="space-y-1">
                <Label htmlFor="district" className="flex items-center text-slate-700 dark:text-slate-300 font-bold text-sm">
                  <MapPin className="h-4 w-4 mr-2" />
                  District
                </Label>
                <Select onValueChange={setDistrict} required value={district} disabled={!division}>
                  <SelectTrigger id="district" className="h-12 border-gray-200 dark:border-slate-800 rounded-xl focus:ring-orange-500 bg-transparent">
                    <SelectValue placeholder="Select" />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <div className="space-y-1">
              <Label htmlFor="whatsapp" className="flex items-center text-slate-700 dark:text-slate-300 font-bold text-sm">
              ...
              <Input
                id="whatsapp"
                type="tel"
                className={`h-12 border-gray-200 dark:border-slate-800 rounded-xl focus-visible:ring-orange-500 transition-all bg-transparent ${isWhatsAppInvalid ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
            ...
            <Button 
                type="submit" 
                className="w-full text-lg h-14 rounded-xl bg-orange-600 hover:bg-orange-700 text-white font-bold transition-all shadow-lg active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed" 
