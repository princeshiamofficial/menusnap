  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 bg-background min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Manage Happy Client reviews, spotlight carousel testimonials, and restaurant ratings.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-card border border-border rounded-2xl p-5 shadow-sm">
          <div className="flex items-center justify-between text-muted-foreground text-xs font-semibold uppercase">
            <span>Spotlight Clients</span>
            <Sparkles className="h-4 w-4 text-amber-400" />
          </div>
          <p className="text-2xl font-black text-foreground mt-2">
            {testimonials.filter(t => t.isSpotlight).length}
          </p>
        </div>
        <div className="bg-card border border-border rounded-2xl p-5 shadow-sm">
          <div className="flex items-center justify-between text-muted-foreground text-xs font-semibold uppercase">
        ...
        <DialogContent className="max-w-lg bg-card border-border">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs text-muted-foreground">
              Enter restaurant testimonial details for Happy Clients showcase.
            </DialogDescription>
          </DialogHeader>
