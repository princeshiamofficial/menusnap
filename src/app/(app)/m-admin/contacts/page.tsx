...
export default function ContactsPage() {
  ...
  return (
    <div className="p-4 sm:p-8 w-full max-w-[1700px] mx-auto space-y-8 animate-in fade-in duration-500 overflow-x-hidden">
      {/* Header Section */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-2 sm:gap-4 sm:mr-2">
                {timezone && (
                ...
                <div className="flex items-center px-4 py-2 bg-slate-900 text-white rounded-full text-xs sm:text-sm font-bold shadow-lg shadow-slate-200">
                    {totalContacts} Total
                </div>
            </div>
            <Button variant="outline" size="sm" onClick={handleRefresh} disabled={loading} className="gap-2 rounded-full h-9 sm:h-10 px-4 sm:px-5 border-slate-200 hover:bg-slate-50 hover:text-slate-900 transition-all font-semibold text-xs sm:text-sm">
      ...
      <Card className="border-slate-200/60 shadow-xl shadow-slate-200/40 rounded-3xl overflow-hidden bg-white">
          <CardHeader className="border-b border-slate-100 px-5 sm:px-8 py-5 sm:py-6">
